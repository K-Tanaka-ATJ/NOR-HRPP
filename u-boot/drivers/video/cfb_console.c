...
/* +Modified for iMX6Solo_PP at 2015/09/14 by Akita */
#ifdef IMX6SOLO_PP
...
#define RGB555_R_OFFSET     10
#define RGB555_G_OFFSET     5
#define RGB555_B_OFFSET     0

static int RGB565Tab5[32] = {0, 8, 16, 25, 33, 41, 49, 58,
...
int video_display_bitmap(ulong bmp_image, int x, int y)
{
    ...
    printf("video_display_bitmap: video mode 0x%X\n", VIDEO_DATA_FORMAT);
...
/* +Modified for iMX6Solo_PP at 2015/09/14 by Akita */
    ...
    case 16:
        ...
        case GDF_16BIT_565RGB:
            {
                ...
                debug("video_display_bitmap: 16bpp BMP, GDF_16BIT_565RGB.\n");
                while (ycount--) {
                    WATCHDOG_RESET();
                    xcount = width;
                    while (xcount--) {
                        bpp16 = (bmap[1]<<8) + bmap[0];
                        /* Bitmap is RGB555 format. */
                        FILL_16BIT_565RGB(RGB565Tab5[(bpp16 & RGB555_R_MASK) >> RGB555_R_OFFSET],
                                          RGB565Tab5[(bpp16 & RGB555_G_MASK) >> RGB555_G_OFFSET],
                                          RGB565Tab5[(bpp16 & RGB555_B_MASK)]);
                        bmap += 2;
                    }
                    bmap += padded_line;
                    fb -= (VIDEO_VISIBLE_COLS + width) *
        ...
        default:
            printf("Error: 16 bits/pixel bitmap incompatible "
